    ...
    # ============ CONFIG ============
    BOT_TOKEN = "8623879654:AAEflSZEUDhcnw7q-FP3R3dZM3M4wrjdUTA"
    API_ID = 28244331
    API_HASH = "9dc4010fcb3efe01ad4602c368af2d44"
    LOG_CHANNEL = None
    OWNER_ID = 8742730991
    MONGO_URI = "mongodb+srv://samewahiwala_db_user:7464Ankit@cluster0.ymrdqrc.mongodb.net/?appName=Cluster0"
    # ================================
    ...
    # Track pending auth: owner se kaunsa account add ho raha hai
    pending_add = {}
    ...
    async def add_account_cmd(client, message: Message):
        """
        Usage: /addaccount ACC1
        Account name short rakho: ACC1, ACC2, Gmail1, etc.
        """
