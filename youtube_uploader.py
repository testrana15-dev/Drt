            ...
            ACCOUNTS_DIR = "yt_accounts"  # folder jisme sare tokens rahenge
            ...
            class YouTubeUploader:
                ...
                def __init__(self):
                    ...
                    self.accounts = {}
                    self._pending_auth = {}  # account_id -> YouTubeAccount (during auth)
                ...
                def start_auth(self, account_id: str):
                    """Start auth for a new account, returns URL"""
                ...
                def upload_video(self, file_path: str, title: str, description: str = "",
                                 privacy: str = "unlisted", progress_queue=None, loop=None):
                    """Try uploading, auto-rotate on limit exceeded"""
                    if not self.accounts:
                        return None, None
